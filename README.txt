...
iHOS.  You have only created the shell of an AppFuse Java EE
...
将appfuse按照tomcat工程导入eclipse：mvn  eclipse:eclipse sysdeo-tomcat:generate

打包 为运行在Sqlserver数据库下的War包:mvn clean package -Psqlserver -DskipTests=true
