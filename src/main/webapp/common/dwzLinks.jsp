...
<link href="${ctx}/dwz/themes/azure/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${ctx}/dwz/themes/blue/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${ctx}/dwz/themes/cyan/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${ctx}/dwz/themes/default/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${ctx}/dwz/themes/green/style.css" rel="stylesheet" type="text/css" media="screen"/> 
<link href="${ctx}/dwz/themes/orange/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${ctx}/dwz/themes/orangered/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${ctx}/dwz/themes/purple/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${ctx}/dwz/themes/silver/style.css" rel="stylesheet" type="text/css" media="screen"/> --%>
