		...
		var hrPersonCurrentGrid = jQuery(hrPersonCurrentGridIdString);
   		hrPersonCurrentGrid.jqGrid({
	        ...
	        colModel:[
				...
				{name:'hrOrg.orgCode',index:'hrOrg.orgCode',align:'left',width:130,label : '单位编码',hidden:true,highsearch:true},		
				...
				{name:'postTypeTxt',index:'postTypeTxt',align:'left',width:60,label : '<s:text name="hrPersonSnap.postType" />',hidden:false,highsearch:true},				
				{name:'duty.name',index:'duty.name',align:'left',width:60,label : '<s:text name="hrPersonSnap.duty" />',hidden:false,highsearch:true},
				{name:'jobTitleTxt',index:'jobTitleTxt',align:'left',width:60,label : '<s:text name="hrPersonSnap.jobTitle" />',hidden:false,highsearch:true},	
				{name:'nowTitleTime',index:'nowTitleTime',align:'left',width:100,label : '<s:text name="hrPersonSnap.nowTitleTime" />',hidden:false,highsearch:true},				
				...
				{name:'nationTxt',index:'nationTxt',align:'left',width:60,label : '<s:text name="hrPersonSnap.nation" />',hidden:false,highsearch:true},	
				{name:'politicalCodeTxt',index:'politicalCodeTxt',align:'left',width:60,label : '<s:text name="hrPersonSnap.politicalCode" />',hidden:false,highsearch:true},
				...
				{name:'nativePlace',index:'nativePlace',align:'left',width:100,label : '<s:text name="hrPersonSnap.nativePlace" />',hidden:false,highsearch:true},				
				{name:'domicilePlace',index:'domicilePlace',align:'left',width:100,label : '<s:text name="hrPersonSnap.domicilePlace" />',hidden:false,highsearch:true},				
				...
				{name:'educationalLevelTxt',index:'educationalLevelTxt',align:'left',width:60,label : '<s:text name="hrPersonSnap.educationalLevel" />',hidden:false,highsearch:true},
				{name:'degreeTxt',index:'degreeTxt',align:'left',width:60,label : '<s:text name="hrPersonSnap.degree" />',hidden:false,highsearch:true},	
				{name:'school',index:'school',align:'left',width:100,label : '<s:text name="hrPersonSnap.school" />',hidden:false,highsearch:true},	
				{name:'professionTxt',index:'profession',align:'left',width:80,label : '<s:text name="hrPersonSnap.profession" />',hidden:false,highsearch:true},	
