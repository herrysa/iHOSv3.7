...
<!-- -----------------------------------导入脚本END  ----------------------------------- -->
	...
	<!-- -----------------------------------图表START----------------------------------- -->
	<div class="${random}_chartTitle"><a  href="#"><b><font color='#15428B'>1.医院成本结构分析(--按成本用途)</font></b></a><br>&nbsp;</div>
	...
	<!-- -----------------------------------图表START----------------------------------- -->
	<div class="${random}_chartTitle"><a  href="#"><b><font color='#15428B'>2.医院成本结构分析(--按门诊住院)</font></b></a><br>&nbsp;</div>
	<div class="${random}_chartContent"  style="overflow-y:auto;clear:both;border-collapse: collapse;display:block;">
	<table width="100%" border="0" cellspacing="0" cellpadding="3" style="margin-bottom: 100px">
	    <tr> 
	    <td align="right" valign="top">
...
<!-- -----------------------------------图表START----------------------------------- -->
	<div class="${random}_chartTitle"><a  href="#"><b><font color='#15428B'>3.医院成本结构分析(--按成本性质)</font></b></a><br>&nbsp;</div>
	<div class="${random}_chartContent"  style="overflow-y:auto;clear:both;border-collapse: collapse;display:block;">
	<table width="100%" border="0" cellspacing="0" cellpadding="3" style="margin-bottom: 100px">
	    <tr> 
	    <td align="right" valign="top">
...
<!-- -----------------------------------图表START----------------------------------- -->
	<div class="${random}_chartTitle"><a  href="#"><b><font color='#15428B'>4.医院成本结构分析(--按科室类型)</font></b></a><br>&nbsp;</div>
	<div class="${random}_chartContent"  style="overflow-y:auto;clear:both;border-collapse: collapse;display:block;">
	<table width="100%" border="0" cellspacing="0" cellpadding="3" style="margin-bottom: 100px">
	    <tr> 
	    <td align="right" valign="top">
