...
{name:'creator',index:'creator',align:'left',label : '<s:text name="bulletin.creator" />',hidden:false}				
        ...
        onSelectRow: function(rowid) {
		 ...
		 gridComplete:function(){
			 gridContainerResize('bulletin','div');
...
//             }
	...
	/*jQuery("#selectDeptName").treeselect({
		dataType:"sql",
		optType:"single",
...
*/
	/*addTreeSelect("tree","sync","selectDeptNamemul","selectDeptIdmul","multi",{tableName:"t_menu",treeId:"menuId",treeName:"menuName",parentId:"parentId",filter:""});*/
...
<div class="page" id="bulletin_page">
	<div id="bulletin_pageHeader" class="pageHeader">
			<div class="searchBar">
				<div class="searchContent">
				<form id="bulletin_search_form"  class="queryarea-form">
...
<!-- 				</div> -->
	...
	<div class="pageContent">
		<div class="panelBar" id="bulletin_buttonBar">
			<ul class="toolBar" id="bulletin_toolbuttonbar">
	...
	<div class="panelBar" id="bulletin_pageBar">
		<div class="pages">
