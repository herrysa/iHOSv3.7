...
<head>
<title><fmt:message key="departmentList.title" />
</title>
<meta name="heading"
	content="<fmt:message key='departmentList.heading'/>" />
<meta name="menu" content="DepartmentMenu" />
<!--     <script type="text/javascript" src="/struts/js/struts2/grid.setcolumns.js"></script> -->
<!--   /struts/js/struts2/jquery.struts2-3.2.0.min.js"
    js/struts2/jquery.grid.struts2-3.2.0"+jQuery.struts2_jquery.minSuffix+".js")
     -->

<script type="text/javascript">
	var showIds = null;
    function displayTree(){
		var url = "displayDepartmentTree?popup=true";
		var winTitle='<fmt:message key="departmentNew.title"/>';
		openWindow(url, winTitle, " width=1000");
	}
    function displayJsTree(){
		var url = "displayJsDepartmentTree?popup=true";
		var winTitle='<fmt:message key="departmentNew.title"/>';
		openWindow(url, winTitle, " width=1000");
	}
    function displayZTree(){
		var url = "displayDepartmentZTree?popup=true";
		var winTitle='<fmt:message key="departmentNew.title"/>';
		openWindow(url, winTitle, " width=1000");
	}
    	function addRecord(){
			var url = "editDepartment?popup=true";
			var winTitle='<fmt:message key="departmentNew.title"/>';
			openWindow(url, winTitle, " width=1000");
		}
		...
		function editRecord(){
	        var sid = jQuery("#department_gridtable").jqGrid('getGridParam','selarrrow');
	        ...
	        if(sid.length>1){
	         ...
	         jQuery("#gridinfo").html('<p>Loading..... ID : '+sid+'</p>');
				var url = "editDepartment?popup=true&departmentId=" + sid;
				var winTitle='<fmt:message key="departmentNew.title"/>';
				openWindow(url, winTitle, " width=1000");
			}
		}
		...
		jQuery.subscribe('showcolumns', function() {          
			jQuery("#department_gridtable").jqGrid('columnChooser');         
			});
...
// 				        }
		...
		//
		function checkDeptData(){
			executeSp('checkPKtoFK',null,null,null,"executeSp?proArgsStr=t_department,' ',' '");
		}
