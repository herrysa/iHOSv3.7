...
// 	}
	...
	function deptFormCallBack(data) {
		...
		if(flag == "true"){
			dealTreeNodeC("departmentLeftTree",treeNode,"add");
		} else {
			dealTreeNodeC("departmentLeftTree",treeNode,"change");
		}
	}
</script>
	<div class="page">
...
<%-- 							value="%{department.parentDept.departmentId}" /> --%>
					...
					<div class="unit">
						<label><fmt:message key='department.outin' />:</label> <span class="formspan" style="float: left; width: 140px">
						 <s:select key="department.outin" name="department.outin" value="%{department.outin}" cssClass="input-small" id="department.outin" required="false" maxlength="10" list="outinList" listKey="value" listValue="content" emptyOption="true" theme="simple"></s:select>
						</span> 
...
<%-- 							onfocus="clearInput(this)" onblur="setDefaultValue(this,jQuery('#departmentparentDeptdepartmentId'))" onkeydown="setTextColor(this)"/> --%>
					...
					<div class="unit">
						...
						<s:textfield required="false"
							id="departmentJJNameC" cssClass="input-small" maxlength="30"
					...
					<div class="unit">
						...
						<label><fmt:message key='department.jjLeaf' />:</label> <span
							style="float: left; width: 140px"> <s:checkbox
								key="department.jjLeaf" required="false" theme="simple"></s:checkbox>
						</span>
					</div>
					<div class="unit">
						<s:textfield required="false" 
							id="departmentYjNameC" cssClass="input-small" maxlength="30" name="department.yjDeptName"
					...
					<div class="unit">
						<label><fmt:message key='department.jjDeptType' />:</label> <span class="formspan" style="float: left; width: 140px">
						 <s:select key="department.jjDeptType" name="department.jjDeptType.khDeptTypeId" value="%{department.jjDeptType.khDeptTypeId}" cssClass="input-small" id="department.jjDeptType" required="false" maxlength="10" list="jjDeptTypeList" listKey="khDeptTypeId" listValue="khDeptTypeName" theme="simple"></s:select>
						</span>
