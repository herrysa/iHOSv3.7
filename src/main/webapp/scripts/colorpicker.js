...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
            $("body").append('<div id="colorpanel" style="position: absolute; display: none;z-index:2000"></div>');
            if(opts.ifr){
		    	$('#colorpanel').resize(function(e,w,h,t,l,hide){
		    		bgiframe($('#colorpanel'),e,w,h,t,l,hide);
		    	});
		    }
            var colorTable = '';
            var colorValue = '';
