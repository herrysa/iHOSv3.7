...
public class StartupListener
    ...
    public static void setupContext( ServletContext context ) {
        ...
        DictionaryManager dmgr = (DictionaryManager) ctx.getBean( "dictionaryManager" );
        dmgr.getAll();
        DictionaryItemManager dimgr = (DictionaryItemManager) ctx.getBean( "dictionaryItemManager" );
        dimgr.getAll();

        MenuManager mmgr = (MenuManager) ctx.getBean( "menuManager" );
        mmgr.getAll();
        SearchManager smgr = (SearchManager) ctx.getBean( "searchManager" );
        smgr.getAll();
        SearchItemManager simgr = (SearchItemManager) ctx.getBean( "searchItemManager" );
        simgr.getAll();
        SearchOptionManager somgr = (SearchOptionManager) ctx.getBean( "searchOptionManager" );
        somgr.getAll();
