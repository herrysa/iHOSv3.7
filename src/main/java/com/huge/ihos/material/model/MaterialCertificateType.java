...
@Entity
@Table(name = "ma_mate_cert_type")
public class MaterialCertificateType extends BaseObject implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3693001666036995260L;
	/**
	 * 
	 */
	/**
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MaterialCertificateType other = (MaterialCertificateType) obj;
		if (id == null) {
			if (other.id != null)
				return false;
