 ...
 */
@Entity
@Table(name = "kq_monthData")
public class KqMonthData extends BaseObject implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 8967695491670906677L;
	...
	private String status = "0";//状态0新增；1审核；2提交；3通过；4；退回
	...
	public String toString() {
		return "KqUpdata [kqId=" + kqId + ", orgCode="
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		KqMonthData other = (KqMonthData) obj;
		if (kqId == null) {
			if (other.kqId != null)
				return false;
