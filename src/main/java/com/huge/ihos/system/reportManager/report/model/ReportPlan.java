...
@Entity
@Table(name = "sy_report_plan")
public class ReportPlan extends BaseObject {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8800648946808645472L;
	...
	public String toString() {
		return "ReportPlan [planId=" + planId + ", planName=" + planName
