...
public class CopyOfGlobalParamAction extends JqGridBaseAction {
	/**
	 * 
	 */
	...
	private Set<Map<String, Object>> subSystems;
	...
	public void prepare() throws Exception {
		...
		this.subSystems = ContextUtil.getAllowSubSystem("0");
	...
	public Set<Map<String, Object>> getSubSystems() {
		return subSystems;
	}

	public void setSubSystems(Set<Map<String, Object>> subSystems) {
