...
@Entity
@Table(name="t_dataPrivilege")
public class DataPrivilege extends BaseObject implements Serializable {
	...
	public String toString() {
		return "DataPrivilege [dataPrivilegeId=" + dataPrivilegeId
				+ ", roleId=" + roleId + ", classCode=" + classCode
