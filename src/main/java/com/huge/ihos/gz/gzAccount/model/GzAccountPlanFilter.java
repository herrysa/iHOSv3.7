...
@Entity
@Table(name = "gz_account_plan_fliter")
public class GzAccountPlanFilter extends BaseObject{

	/**
	 * 
	 */
	private static final long serialVersionUID = -8389901375713703022L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GzAccountPlanFilter other = (GzAccountPlanFilter) obj;
		if (filterCode == null) {
	...
	public String toString() {
		return "GzAccountPlanFliter [filterId=" + filterId + ", planId="
