...
import com.huge.ihos.system.systemManager.security.webapp.action.PasswordHintAction;
...
public class PasswordHintActionTest
    ...
    @Test
    public void testExecuteWrongUserName()
        throws Exception {
  ...
  //  @Test
    public void testExecuteNoPasswordHintUserName()
        throws Exception {
